...
const insertUser = async (req, res, next) => {
  try {
    ...
    if (userData) {
      ...
      res.render("otp", {
        message: "your registration is sucessfull,check your mail",
        email: req.body.email,
      });
    } else {
...
//  finding categories for displaying in user side
...
// displaying products in user side
